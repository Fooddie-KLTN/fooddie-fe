// adminApi.ts
import { Address, FoodDetail, Promotion, Restaurant, Review, ShippingDetail, UserProfile } from "@/interface";
...
export interface OrderResponse {
	...
	shippingDetail: ShippingDetail | null; // Shipping details object or null
...
export const adminService = {
	...
	Order: {
		...
		async getOrderById(token: string, id: string): Promise<OrderResponse> {
			try {
				return await apiRequest<OrderResponse>(`/orders/${id}`, 'GET', {
					token, query: { review: true }
